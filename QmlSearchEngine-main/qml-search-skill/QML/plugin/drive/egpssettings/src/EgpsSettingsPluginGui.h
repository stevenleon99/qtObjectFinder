...
class EgpsSettingsPluginGui final : public QObject, public drive::itf::plugin::ISettingsPluginGui
{
    Q_OBJECT
...
public:
    explicit EgpsSettingsPluginGui();
    ~EgpsSettingsPluginGui() override = default;
