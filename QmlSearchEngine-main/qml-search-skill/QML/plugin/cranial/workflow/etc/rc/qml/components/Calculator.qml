...
Popup {
    ...
    function setup(positionItem, value, resultFuction) {
        positionCalculator(positionItem)
        m.resultFuction = resultFuction
        calculatorPositionViewModel.setCalculatorSetup(value)
        open()
    }
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            Label {
                ...
                text: "LPS"//calculatorPositionViewModel.coordinateLabel
            }
            ...
            Repeater {
                ...
                CalculatorButton {
                    enabled: switch (role_buttonType) {
                             ...
                             case CalculatorButtonType.Backspace_Button: 
                             case CalculatorButtonType.Plus_Button:
                             case CalculatorButtonType.Minus_Button: return true
