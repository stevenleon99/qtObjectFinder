 ...
 * \ingroup TestCode
 * \brief \b eventplayer.exe: Utility for playing back events from db with different algorithms parameters
 *  Code mainly in gps-client/testcode/eventplayer subdirectory.
 */

int main(int argc, char *argv[])
{
    QApplication a(argc, argv);
    qApp->addLibraryPath(QCoreApplication::applicationDirPath() + QDir::separator() + "plugins");
