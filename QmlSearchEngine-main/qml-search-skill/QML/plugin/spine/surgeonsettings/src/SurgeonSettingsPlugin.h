...
class SurgeonSettingsPlugin final : public QObject, public drive::itf::plugin::IPlugin
{
    Q_OBJECT
...
public:
    explicit SurgeonSettingsPlugin(QObject* parent = nullptr);
    ~SurgeonSettingsPlugin() override = default;
