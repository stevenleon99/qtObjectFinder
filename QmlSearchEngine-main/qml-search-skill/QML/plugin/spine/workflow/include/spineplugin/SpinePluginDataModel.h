...
const auto GM_PLUGIN_DATAMODEL_INTERFACE_IID =
    "com.globusmedical.Interfaces.gm.CranialDataModel/1.0";
Q_DECLARE_INTERFACE(drive::itf::plugin::IWorkflowPluginDataModel, GM_PLUGIN_DATAMODEL_INTERFACE_IID)

class SpinePluginDataModel final : public QObject,
...
public:
    explicit SpinePluginDataModel(QObject* parent = nullptr);
    ~SpinePluginDataModel() override = default;
    ...
    createNewCase(drive::model::DrivePatientData data) override;
