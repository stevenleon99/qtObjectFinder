        ...
        Repeater {
            ...
            Label {
                ...
                x: switch (role_position) {
                   ...
                   case "right": return parent.width - width - Theme.margin(1)
                   case "bottom": return (parent.width / 2) - (width / 2)
                   case "left": return Theme.margin(1)
                   default: return 0
                   }
                y: switch (role_position) {
                   case "top": return Theme.margin(1)
                   case "right": return (parent.height / 2) - (height / 2)
                   case "bottom": return parent.height - height - Theme.margin(1)
