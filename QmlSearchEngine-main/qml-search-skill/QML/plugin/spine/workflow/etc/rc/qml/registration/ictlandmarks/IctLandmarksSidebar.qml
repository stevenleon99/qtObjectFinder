...
Item {
    ...
    ColumnLayout {
        ...
        SidebarHeader {
            ...
            pageNumber: 5
            maxPageNumber: 5
            description: qsTr("Transfer registration when DRB & ICT are visible and site is stable.")
            ...
            ColumnLayout {
                ...
                CheckDelegate {
                    ...
                    onClicked: ictLandmarksViewModel.registerPatient()
                ...
                CheckDelegate {
                    ...
                    onClicked: ictLandmarksViewModel.areLandmarksChecked = !ictLandmarksViewModel.areLandmarksChecked
                }

                CheckDelegate {
                    enabled: ictLandmarksViewModel.isTransferred && !ictLandmarksViewModel.isIctRemoved
                    Layout.fillWidth: true
                    text: qsTr("Carefully remove ICT")
                    checked: ictLandmarksViewModel.isTransferred && ictLandmarksViewModel.isIctRemoved

                    onClicked: ictLandmarksViewModel.isIctRemoved = !ictLandmarksViewModel.isIctRemoved
                }
            }
        }
